...
<body>
	...
	<input type="hidden" name="memId" name = "memId" id = "memId" />
	<input type="text" name="memName" name = "memName" id = "memName" value ="${members.memName }" readonly/>
...
var messageArea = $("#messageArea");
	...
	// websocket 생성
    const websocket = new WebSocket("ws://localhost/module"); // IP or localhost넣기
